...
try {
	const chalk = new chalk__WEBPACK_IMPORTED_MODULE_0__/* .Chalk */ .cX({ level: 3 });
	...
	let method = (0,_actions_core__WEBPACK_IMPORTED_MODULE_1__.getInput)("method").toLowerCase();
	let key;
	if ((0,_hugoalh_advanced_determine__WEBPACK_IMPORTED_MODULE_2__/* .isString */ .HD)(keyRaw, { pattern: pipedreamKeyRegExp })) {
		key = keyRaw;
		if (method.length === 0) {
			method = "sdk";
		}
	} else if ((0,_hugoalh_advanced_determine__WEBPACK_IMPORTED_MODULE_2__/* .isString */ .HD)(keyRaw, { pattern: pipedreamSDKURLRegExp })) {
		key = keyRaw.match(pipedreamSDKURLRegExp).groups.key;
		if (method.length === 0) {
			method = "sdk";
		}
	} else if ((0,_hugoalh_advanced_determine__WEBPACK_IMPORTED_MODULE_2__/* .isString */ .HD)(keyRaw, { pattern: pipedreamWebhookURLRegExp })) {
	...
	(0,_actions_core__WEBPACK_IMPORTED_MODULE_1__.setSecret)(key);
	...
	(0,_actions_core__WEBPACK_IMPORTED_MODULE_1__.startGroup)(`Post network request to Pipedream.`);
	let response = await (0,node_fetch__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .ZP)((method === "sdk") ? `https://sdk.m.pipedream.net/pipelines/${key}/events` : `https://${key}.m.pipedream.net`, {
	...
	(0,_actions_core__WEBPACK_IMPORTED_MODULE_1__.setOutput)("status_code", response.status);
	(0,_actions_core__WEBPACK_IMPORTED_MODULE_1__.setOutput)("status_ok", response.ok);
	(0,_actions_core__WEBPACK_IMPORTED_MODULE_1__.setOutput)("status_text", response.statusText);
	if (!response.ok) {
